...
export default function MapaRodovias({ className = '' }) {
  ...
  return (
    <div className={className}>
      ...
      <div className="reveal mx-auto max-w-[760px] rounded-[16px] border border-line bg-paper p-2">
        <svg
        ...
        <div className="mt-2 border-t border-line px-4 pb-3 pt-4 max-mob:px-2">
          <div className="grid grid-cols-2 gap-x-10 gap-y-5 max-mob:grid-cols-1 max-mob:gap-y-4">
            <Grupo titulo="Pontos">
      ...
      <p className="reveal mt-4 text-center text-[13px] leading-relaxed text-ink-soft">
