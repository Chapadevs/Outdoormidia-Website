...
// públicos da empresa (mais de 530 milhões de impactos/mês, 175 telas digitais)
// e servem para o visitante ter uma noção antes
...
//
// TODO(cliente): a faixa abaixo é ordem de grandeza estimada, não tabela. O
// R$ 2,06 por mil impactos em rodovias que circulava em versões antigas do FAQ
// saiu de circulação em 26/08/2026: nenhum material do projeto registra esse
// número e a origem nunca foi identificada. Falta o comercial validar um CPM de
// referência — quando validar, ele entra aqui e volta para a resposta de custo
// em lib/faq.js.
const CPM_MIN = 8
const CPM_MAX = 14
...
import { PERIODOS as en } from '@/lib/i18n/content/simulador.en'
import { PERIODOS as es } from '@/lib/i18n/content/simulador.es'
import { PERIODOS as zh } from '@/lib/i18n/content/simulador.zh'

const conteudo = porLocale(PERIODOS, { en, es, zh })

export function getPeriodos(locale) {
