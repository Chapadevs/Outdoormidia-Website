...
// escuro com o nome do projeto. `imageAlt` vem junto com ela: descreve a cena
// da foto — sem ele o alt cai no nome do projeto mais o `short`.
export const ICONICOS = [
  {
    ...
    // TODO(cliente): PROVISÓRIA — foto do acervo geral, não é deste
    // projeto. Trocar pela foto real antes de subir para produção.
    image: '/media/OM-Foto.jpeg',
    imageAlt: 'Painel digital vertical em avenida no fim de tarde',
  ...
  },
  {
    ...
    // TODO(cliente): PROVISÓRIA — foto do acervo geral, não é deste
    // projeto. Trocar pela foto real antes de subir para produção.
    image: '/media/hero-billboard.webp',
    imageAlt: 'Outdoor da Outdoormídia ao entardecer',
