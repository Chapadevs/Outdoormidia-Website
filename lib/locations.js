...
export const DEFAULT_LOCATIONS = [
  {
    ...
    lat: -25.43,
    lng: -49.27,
    formats: ['Outdoor Digital', 'Front Light', 'Projetos Icônicos', 'Malls', 'MUB'],
  },
  {
    ...
    lat: -25.53,
    lng: -49.2,
    formats: ['Front Light', 'Outdoor Digital', 'Aeroporto'],
  },
  {
    id: 'litoral-pr',
    name: 'Litoral do PR',
    ...
    lat: -25.82,
    lng: -48.55,
    formats: ['Front Light', 'Mídia Móvel'],
  },
  {
    id: 'rodovias',
    name: 'Rodovias',
    desc: 'BR 101, 116, 277 e 376, nos dois estados',
    lat: -24.95,
    lng: -50.1,
    formats: ['Rodovias', 'Front Light', 'Outdoor Digital'],
  },
  {
    id: 'santa-catarina',
    name: 'Santa Catarina',
    ...
    lat: -26.91,
    lng: -48.66,
    formats: ['Outdoor Digital', 'Front Light', 'Rodovias'],
  },
]
...
// O conteudo gravado no Firestore e escrito pelo cliente e existe num idioma
// so: quando a colecao tem documentos, e ele que vai para a tela em qualquer
// idioma. O overlay alcanca apenas a lista padrao, que e o que responde
// enquanto a colecao estiver vazia.
export async function getLocations(locale) {
  const padrao = getDefaultLocations(locale)
  try {
...
// Versao de cada idioma da lista padrao.
import { porLocale } from '@/lib/i18n/overlay'
import { DEFAULT_LOCATIONS as en } from '@/lib/i18n/content/locations.en'
import { DEFAULT_LOCATIONS as es } from '@/lib/i18n/content/locations.es'
import { DEFAULT_LOCATIONS as zh } from '@/lib/i18n/content/locations.zh'

const conteudo = porLocale(DEFAULT_LOCATIONS, { en, es, zh })

export function getDefaultLocations(locale) {
