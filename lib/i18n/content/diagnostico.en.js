...
export const PERGUNTAS = [
  ...
  },
  {
    ...
    fragil: {
      ...
      cta: 'With Face Única, each site belongs to a single advertiser. Talk to our team about exclusivity in your area.',
    },
  },
  {
...
export const DEGRAUS = [
  ...
  },
  {
    ...
    paragrafos: [
      ...
      'The next step is Preference, and it grows out of consistency combined with exclusivity of space. With Face Única, each site belongs to a single advertiser: your brand does not share attention with the competition precisely where the decision is formed.',
    ],
  },
  {
    nome: 'Preference',
