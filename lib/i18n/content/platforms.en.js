...
export const PLATFORMS = [
  {
    ...
    destaque: {
      title: 'Digital Wallscape',
      text: 'Turn large façades and building sidewalls into high-impact placements for your brand. Outdoormídia wallscapes offer a wide display area, a commanding presence and privileged visibility at strategic points across the city.',
      imageAlt:
        'Outdoormídia digital wallscape on the side of a building at dusk, with two lit LED panels showing the same campaign',
    },
    faqs: [
      {
  ...
  },
  {
    ...
    bignumbers: [
      { n: '+70k', label: 'People/month at Shopping São José' },
      { n: '150k', label: 'People/month at Shopping Itália' },
      { n: '35k', label: 'People/month at Park Shopping Boulevard' },
      { n: '255k', label: 'People/month across the malls' },
    ],
  ...
  },
  {
    ...
    desc: 'Hybrid · 577.5 m²',
    short:
      'Duo Square Media District: 5 LED screens and 10 frontlights on the only exit road of Afonso Pena International Airport. The set houses Airport Square, the largest hybrid panel in Southern Brazil.',
    eyebrow: 'Platform · Hybrid · 577.5 m²',
    heading: 'Airport.',
    intro:
      'Everyone who arrives in Curitiba by plane passes through a single exit road, in a metropolitan region of almost 3.7 million people. That is where Duo Square Media District sits, the first project of its kind in Brazil, designed to build qualified presence right at arrival.',
    quando: [
    ...
    bignumbers: [
      { n: '577.5 m²', label: 'Visual area' },
      { n: '800k', label: 'Impacts per month' },
      { n: '14.8M', label: 'Passengers per year' },
      { n: '3.7M', label: 'Inhabitants in the region' },
    ],
  ...
  },
  {
    ...
    bignumbers: [
      { label: 'Highway panels' },
      { label: 'Highway locations' },
      { n: '2.8M', label: 'Impacts per month per site' },
      { n: '42M', label: 'Impacts over 15 months' },
    ],
    passos: [
      {
  ...
  {
    clientesImageAlt: 'Poster reading "Empresas que atendemos" with the logos of Ademicon, Direção Marcas e Patentes, Jota Imóveis, Servopa, Audiotec, Laguna, Suprema Propriedade Intelectual and Vanguard',
    // digital-signage
    desc: 'Bespoke · OM 360 Management',
    short:
    ...
    formats: [
      {
        ...
        imageAlt: 'Outdoormídia vertical LED panel in front of the Vanguard store, next to the facade lettering',
      },
      {
        dims: 'Station',
        side: 'Bespoke',
        ...
        imageAlt: 'Outdoormídia vertical LED panel on the Audiotec facade, showing the store brand',
      },
      {
        dims: 'Passage',
        side: 'Bespoke',
        ...
        imageAlt: 'Outdoormídia LED panel by the entrance of a clinic, showing the practice brand and contact',
      },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        a: 'We do. On exclusive panel projects, OM 360 Management includes legal consulting on licensing and on sizing within municipal decrees.',
      },
      {
