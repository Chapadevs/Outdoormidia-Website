...
export const PLATFORMS = [
  {
    ...
    destaque: {
      title: 'Medianera Digital',
      text: 'Transforme grandes fachadas y laterales de edificios en puntos de alto impacto para su marca. Las medianeras Outdoormídia ofrecen una amplia área de exposición, presencia contundente y visibilidad privilegiada en lugares estratégicos de la ciudad.',
      imageAlt:
        'Medianera digital de Outdoormídia en el lateral de un edificio al atardecer, con dos pantallas LED encendidas mostrando la misma campaña',
    },
    faqs: [
      {
    ...
    formats: [
      {
        ...
        imageAlt: 'Panel de LED vertical de Outdoormídia frente a la tienda Vanguard, junto al letrero de la fachada',
      },
      {
        dims: 'Estación',
        side: 'A medida',
        ...
        imageAlt: 'Panel de LED vertical de Outdoormídia en la fachada de Audiotec, mostrando la marca de la tienda',
      },
      {
        dims: 'Pasaje',
        side: 'A medida',
        ...
        imageAlt: 'Panel de LED de Outdoormídia junto al acceso de una clínica, mostrando la marca y el contacto del consultorio',
      },
    ],
    faqs: [
      {
