...
export const PLATFORMS = [
  ...
  },
  {
    ...
    short:
      'Distrito de Mídia Duo Square: 5 pantallas LED y 10 frontlights en la única vía de salida del Aeropuerto Internacional Afonso Pena. El conjunto alberga el Aeroporto Square, mayor panel híbrido del Sur de Brasil.',
    eyebrow: 'Plataforma · Híbrido · 577,5 m²',
    heading: 'Aeropuerto.',
    intro:
      'Quien llega a Curitiba en avión pasa por una única vía de salida, en la región metropolitana con casi 3,7 millones de habitantes. Es ahí donde está el Distrito de Mídia Duo Square, el primer proyecto del tipo en Brasil, concebido para generar presencia calificada ya en el desembarque.',
    quando: [
    ...
    formats: [
      {
        label: 'Medianera',
        title: 'Medianera digital 6×18 m',
        text: 'La mayor medianera digital del Sur de Brasil, con visibilidad total dentro de la terminal.',
      },
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    bignumbers: [{ label: 'Circuitos por nicho' }, { label: 'Formatos digitales' }],
    formats: [
      {
        label: 'Pasarela',
        title: 'Pasarela MUB',
  ...
  },
  {
    ...
    bignumbers: [
      { label: 'Impactos por mes' },
      { label: 'Impactos en 12 meses' },
      { label: 'Impactos en 24 meses' },
      { label: 'BR cubiertas' },
    ],
    passos: [
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Nosotros. En proyectos de panel exclusivo, el Gestão 360 OM incluye consultoría legal de licenciamiento y el dimensionamiento dentro de los decretos municipales.',
      },
      {
