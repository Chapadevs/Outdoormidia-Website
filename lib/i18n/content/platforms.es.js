    ...
    formats: [
      {
        ...
        imageAlt: 'Fachada digital de Outdoormídia, panel de LED integrado al lateral de un edificio comercial, orientado a la avenida',
      },
      {
        dims: 'Estación',
        side: 'A medida',
        ...
        imageAlt: 'Panel de LED vertical de Outdoormídia en la fachada de un edificio comercial',
      },
      {
        dims: 'Pasaje',
        side: 'A medida',
        ...
        imageAlt: 'Panel de LED vertical de Outdoormídia instalado junto a la entrada de un edificio',
      },
    ],
    faqs: [
      {
