...
export const PERGUNTAS_ANTES_DE_FECHAR = [
  {
    ...
    porque:
      'It determines whether your brand shares attention in that field of view. At Outdoormídia, Single Face guarantees that it does not',
  },
  {
