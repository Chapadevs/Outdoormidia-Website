...
export const PRODUTOS = [
  {
    ...
    imagemPor: {
      estatico: { alt: 'Panel Top Sight estático de Outdoormídia junto a una vía, en Curitiba' },
    },
  },
  {
    kicker: 'Horizontal',
    ...
    imagemPor: {
      digital: { alt: 'Panel Poster Sight digital de Outdoormídia con campaña en LED sobre la vía' },
    },
  },
  {
    kicker: 'Gran formato',
    ...
    imagemPor: {
      digital: { alt: 'Estructura Billboard de Outdoormídia iluminada de noche, con campaña de gran formato' },
    },
  },
  {
    name: 'Azotea',
    ...
    textPor: {
      digital:
        'El formato más alto del portafolio, en lo alto de las dos ciudades más relevantes de Santa Catarina. En Balneário Camboriú, panel digital en punto destacado de la Av. Brasil. En Joinville, panel digital con contenido en tiempo real. Visibilidad premium para marcas que buscan protagonismo en el paisaje, donde solo Outdoormídia llega.',
    },
    pontos: [
    ...
    imagemPor: {
      estatico: { alt: 'Panel Azotea estático de Outdoormídia en lo alto de un edificio' },
      digital: { alt: 'Panel Azotea digital de Outdoormídia en lo alto de un edificio' },
    },
  },
  {
    kicker: '2x mayor',
  ...
  },
  {
    ...
    imageAlt: 'Trío de Bike Media de Outdoormídia circulando por el césped de un parque de Curitiba, con la rueda gigante al fondo',
  },
  {
    name: 'Bus Media',
    kicker: 'Ruta urbana',
    ...
    imageAlt: 'Parte trasera de un autobús con campaña del Bus Media de Outdoormídia ocupando todo el vidrio',
  },
  {
