...
export const PRODUTOS = [
  ...
  },
  {
    ...
    textPor: {
      digital:
        '产品线中位置最高的形式，矗立于圣卡塔琳娜州两座最重要城市的高处。在坎布里乌海滨市，数字大屏位于 Av. Brasil 的黄金地段；在若因维利，一块可实时更新内容的数字屏。为追求在城市天际线中占据主角地位的品牌提供高端曝光，而这样的位置只有 Outdoormídia 能够抵达。',
    },
    pontos: [
      { name: '坎布里乌海滨市' },
      { name: '若因维利 · 数字' },
  ...
  },
  {
    ...
    imageAlt: 'Outdoormídia 单车媒体三车队穿过库里蒂巴一座公园的草坪，背景是摩天轮',
  },
  {
    name: '巴士媒体',
    kicker: '城市路线',
    text: '让品牌进入数千人的日常通勤。Bus Mídia 穿行城市主干道，在不同时段与不同街区反复曝光，以单个点位的成本获得整条线路的覆盖。',
    imageAlt: 'Outdoormídia 巴士媒体广告覆盖整个后车窗的公交车尾部',
  },
  {
    name: '专属广告牌',
