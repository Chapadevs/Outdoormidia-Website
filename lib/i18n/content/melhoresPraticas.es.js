...
export const PRATICAS = [
  ...
  },
  {
    ...
    corpo: 'El entorno entra en la lectura de la pieza. Un panel dividido con otras marcas divide también la atención. Para eso existe el Face Única: la cara entera, sin competencia visual en el mismo campo de visión. Para quien vende posicionamiento antes que precio, el activo elegido forma parte del mensaje.',
    pratica:
...
export const PERGUNTAS_ANTES_DE_FECHAR = [
  {
    ...
    porque:
      'Define si tu marca comparte o no la atención en ese campo de visión. En Outdoormídia, el Face Única garantiza que sí',
  },
  {
