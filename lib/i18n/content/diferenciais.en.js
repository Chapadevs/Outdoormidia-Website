...
export const TODOS_DIFERENCIAIS = [
  {
    ...
    imageAlt:
      'A three-panel billboard structure beside an avenue in Curitiba fully occupied by Colégio Marista’s enrolment campaign',
    aside: {
  ...
  },
  {
    ...
    text: 'Media that leaves the city better than it found it: it restores the space and delivers a utility to the people who live there.',
    resumo: 'Outdoor media that gives a service back to the city, from public safety to pet squares.',
    heading: 'Regenerative Media.',
    subtitulo: [
      'More than occupying a space, Regenerative Media transforms it.',
      'These are projects that revitalise areas of the city and, at the same time, create new possibilities for the population. Media stops being just a point of communication and becomes part of the urban experience, generating a positive impact and a real utility for the people who live the city.',
      'It is the concept behind the Pet Squares, which create spaces of leisure and coexistence for animals and their owners, and the Charging Squares, which offer infrastructure and convenience to the population.',
      'Because regenerating the city is more than transforming spaces. It is creating value for people.',
    ],
    intro:
      'Regenerative Media is the project that creates a positive effect for the city. Restoring the space is only the start: the structure delivers a utility to the population, like the leisure of the Pet Squares and the energy of the Electric Charging Square. The brand sponsors something the neighbourhood uses every day, even when no one is looking at the ad, and that keeps serving a purpose after the campaign ends. Urban presence is also urban responsibility.',
    ...
    aside: {
      text: 'The test is simple: a project is regenerative when, beyond restoring the space, it delivers a utility to the people who pass through it. A square to take the dog to, a point to charge the car. The city gains before the campaign even goes live.',
      footer: 'Pet Squares and Electric Charging Square, Curitiba',
    },
    oQueGanha: {
      eyebrow: 'Pioneering · Urban safety',
      title: 'Regenerative Media',
      lead: [
        '**Praça de Conveniência Batel**. The **first outdoor media asset connected to Curitiba’s Muralha Digital**, the city’s urban monitoring and intelligence system.',
        'The structure keeps doing its job of connecting brands and people, but now also contributes to **public safety** and to the quality of the urban space. It brings monitoring integrated with the Muralha Digital and an **emergency button** installed to support people in vulnerable situations, in one of the most used gathering spaces in the city.',
        'We are **pioneers in integrating outdoor media and urban safety** in Curitiba. In a market that talks about ESG and smart cities, this is the difference between **occupying a space and qualifying a space**.',
        'For the advertiser, it is the chance to be on a structure the city recognises as useful. **Urban presence is also urban responsibility**, and the best communication is the kind that leaves a legacy.',
      ],
    },
    carteira: {
