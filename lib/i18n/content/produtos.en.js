...
export const PRODUTOS = [
  ...
  },
  {
    ...
    textPor: {
      digital:
        'The tallest format in the portfolio, high above the two most relevant cities in Santa Catarina. In Balneário Camboriú, a digital panel at a prime spot on Av. Brasil. In Joinville, a digital panel with real-time content. Premium visibility for brands seeking a leading role in the skyline, where only Outdoormídia reaches.',
    },
    pontos: [
  ...
  },
  {
    ...
    imageAlt: 'Outdoormídia Bike Media trio riding across the lawn of a Curitiba park, with the Ferris wheel in the background',
  },
  {
    name: 'Bus Media',
    kicker: 'Urban route',
    ...
    imageAlt: 'Rear of a bus with an Outdoormídia Bus Media campaign covering the entire window',
  },
  {
