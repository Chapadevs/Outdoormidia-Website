...
export const PERGUNTAS = [
  ...
  },
  {
    ...
    fragil: {
      ...
      cta: 'Con Face Única, cada punto es de un único anunciante. Habla con nuestro equipo sobre exclusividad en tu plaza.',
    },
  },
  {
...
export const DEGRAUS = [
  ...
  },
  {
    ...
    paragrafos: [
      ...
      'El siguiente escalón es la Preferencia, y nace de la constancia combinada con exclusividad de espacio. Con Face Única, cada punto es de un único anunciante: tu marca no comparte atención con la competencia justamente donde se forma la decisión.',
    ],
  },
  {
    nome: 'Preferencia',
