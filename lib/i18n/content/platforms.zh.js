...
// (数字大牌, 灯箱大牌, MUB, 数字标牌). Mesmo critério do menu.
//
...
export const PLATFORMS = [
  {
    ...
    destaque: {
      title: '数字楼体大屏',
      text: '将大型外立面和建筑侧墙变为品牌的高冲击力展示点。Outdoormídia 楼体大屏拥有宽阔的展示面积、醒目的存在感，以及城市战略位置上的优越可见度。',
      imageAlt: '黄昏时分，Outdoormídia 数字楼体大屏位于建筑侧墙，两块点亮的 LED 屏展示同一广告',
    },
    faqs: [
      {
        q: '我需要制作印刷素材吗？',
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: '画面制作包含在内吗？',
        a: '灯箱大牌属于印刷格式，因此素材制作与点位租用是一并进行的。',
      },
      {
        q: '投放期间可以更换点位吗？',
  ...
  },
  {
    ...
    bignumbers: [
      { n: '+7万', label: 'Shopping São José 每月客流' },
      { n: '15万', label: 'Shopping Itália 每月客流' },
      { n: '3.5万', label: 'Park Shopping Boulevard 每月客流' },
      { n: '25.5万', label: '三家购物中心每月客流' },
    ],
    blocosTitle: '三个场景',
    blocos: [
      {
  ...
  },
  {
    ...
    desc: '混合 · 577.5 平方米',
    short:
      'Duo Square 媒体特区：位于 Afonso Pena 国际机场唯一出口道路上的 5 块 LED 屏和 10 面 frontlight。该组合中包含机场广场，巴西南部最大的混合广告牌。',
    eyebrow: '媒体平台 · 混合 · 577.5 平方米',
    heading: '机场。',
    intro:
      '所有乘飞机抵达库里蒂巴的人都要经过唯一一条出口道路，而这里的大都会区人口接近 370 万。Duo Square 媒体特区就坐落于此，是巴西同类项目中的第一个，专为在旅客落地那一刻就建立高质量品牌存在感而设计。',
    quando: [
  ...
  },
  {
    ...
    bignumbers: [
      { label: '公路广告牌数量' },
      { label: '公路覆盖点位区域' },
      { n: '280万', label: '单点每月曝光量' },
      { n: '4200万', label: '15 个月累计曝光' },
    ],
    passos: [
      {
        title: '选择区域。',
    ...
    faqs: [
      ...
      {
        q: '公路业务是数字的还是印刷的？',
        a: '公路业务以印刷为主。如果投放需要动态更换素材，更合适的选择是数字大牌，或者两个平台组合使用。',
      },
    ],
  },
  {
    clientesImageAlt: '「Empresas que atendemos」（我们服务的企业）海报，展示 Ademicon、Direção Marcas e Patentes、Jota Imóveis、Servopa、Audiotec、Laguna、Suprema Propriedade Intelectual 与 Vanguard 的标识',
    name: '数字标牌',
    // digital-signage
    desc: '按需定制 · OM 360 全流程管理',
    short:
    ...
    formats: [
      {
        ...
        imageAlt: 'Outdoormídia 竖向 LED 屏，位于 Vanguard 门店前、外墙招牌旁',
      },
      {
        dims: '加油站',
        top: 'LED',
        ...
        imageAlt: 'Outdoormídia 安装在 Audiotec 外墙的竖向 LED 屏，展示门店品牌',
      },
      {
        dims: '通道',
        top: 'LED',
        ...
        imageAlt: 'Outdoormídia 安装在诊所入口旁的 LED 屏，展示诊所品牌与联系方式',
      },
    ],
    faqs: [
      {
      ...
      {
        q: '许可审批由谁负责？',
        a: '由我们负责。在专属广告牌项目中，OM 360 全流程管理包含许可审批的法务咨询，以及符合市政法令的尺寸规划。',
      },
      {
        q: '广告牌上线之后呢？',
