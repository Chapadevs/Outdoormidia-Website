...
export const PRODUTOS = [
  {
    ...
    imagemPor: {
      ...
      digital: {
        src: '/media/produtos/top-sight-digital.webp',
        alt: 'Painel Top Sight digital da Outdoormídia exibindo campanha em LED',
      },
    },
...
export function getProdutosPorPlataformaLocale(slug, locale) {
  return conteudo(locale).filter((p) => p.plataformas.includes(slug))
}
