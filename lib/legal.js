...
export const TERMOS = [
  ...
  },
  {
    ...
    paragrafos: [
      'O simulador de campanha e o diagnóstico de marca são ferramentas de orientação. Os números que apresentam são estimativas de ordem de grandeza, calculadas a partir de médias da nossa rede — não constituem proposta comercial, não vinculam preço e não garantem resultado.',
