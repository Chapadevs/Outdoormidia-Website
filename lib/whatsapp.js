import { WHATSAPP_URL, WHATSAPP_URL_SC } from '@/lib/constants'
...
// O "Falar com o time comercial" do hero de cada página de plataforma. Leva o
// nome em português do catálogo, mesmo nos outros idiomas: é o nome que o
// comercial reconhece; a etiqueta de `comIdioma` diz em que idioma responder.
export function waPlataforma(plataforma) {
  return `Olá! Tenho interesse em anunciar na plataforma ${plataforma}.`
}
