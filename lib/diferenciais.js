...
export const TODOS_DIFERENCIAIS = [
  {
    ...
    // A capa é o recorte direito do arquivo entregue pelo cliente: no
    // enquadramento inteiro, dois painéis exibem "+380 milhões de impactos
    // mensais", número fora de circulação que não pode voltar a nenhuma página.
    // O original completo está em public/media/images/diferenciais/.
    image: '/media/diferenciais/face-unica.webp',
    imageAlt:
      'Estrutura de mídia exterior da Outdoormídia com todas as faces ocupadas por uma única marca, à beira de uma via em Curitiba',
    aside: {
  ...
  },
  {
    ...
    // Diferencial sem página dedicada: a capa serve o card da home e o da
    // listagem.
    image: '/media/diferenciais/gestao-360-om.webp',
    imageAlt: 'Equipe da Outdoormídia reunida na entrada da sede, em Curitiba',
  },
  {
