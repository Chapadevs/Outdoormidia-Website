...
export const TODOS_DIFERENCIAIS = [
  {
    ...
    // Capa trocada em 08/09/2026 para o Distrito de Mídia (decisão do Erik):
    // o arquivo mostra "+380 milhões de impactos mensais" nos painéis da
    // esquerda, número fora de circulação em qualquer outra página do site,
    // mas o pedido foi usar a imagem inteira, sem recorte, nesta capa.
    image: '/media/diferenciais/distrito-de-midia.png',
    imageAlt:
      'Distrito de Mídia da Outdoormídia, estrutura de frontlights e o letreiro "om" à beira de via em Curitiba',
    aside: {
    ...
    // Fotos aplicadas em 08/09/2026.
    comparativo: {
      amador: {
        label: 'Amador',
        image: '/media/diferenciais/face-unica-1.png',
        imageAlt: 'Três outdoors genéricos dividindo a mesma estrutura, cada um de uma marca diferente',
      },
      especialista: {
        label: 'Especialista',
        image: '/media/diferenciais/face-unica-2.png',
  ...
  },
  {
    ...
    //
    // A Muralha Digital é sistema da Prefeitura de Curitiba, não ativo da
    // Outdoormídia: a copy diz "conectado à", nunca "nossa". Vale para os
    // quatro idiomas.
    ...
    intro:
      'O primeiro ativo de mídia exterior conectado à Muralha Digital de Curitiba, na Praça de Conveniência Batel, com monitoramento integrado e botão de emergência. É a mesma lógica das praças pet, do MUB Garden e da Praça de Carregamento Elétrico: estrutura que a cidade usa mesmo quando não está olhando para a marca. Presença urbana também é responsabilidade urbana.',
    ...
    aside: {
      ...
      footer: 'Praça de Conveniência Batel, Curitiba',
    },
    // Seção "O que é" trocada em 10/09/2026 pelo que a marca ganha com o
    // projeto: o argumento de negócio (presença que vira permanência,
    // associação com o bairro) em vez da anatomia técnica do ativo (Muralha
    // Digital, botão de emergência), que já está dita no `intro` e no `aside`.
    oQueGanha: {
      title: 'Aparecer é diferente de fazer parte',
      lead: [
        'Toda campanha de mídia exterior disputa atenção com o que está em volta. Nos projetos de Mídia Regenerativa, a estrutura é o que está em volta. Ela não interrompe a rotina do bairro, ela participa dela.',
        'Isso muda o tipo de presença que a marca compra. Em uma praça de convivência as pessoas não passam, elas ficam, e permanência é tempo de exposição que a via não entrega. E o público volta, porque o lugar serve para alguma coisa depois que a campanha sai do ar.',
        'Muda também o que a marca leva junto. Patrocinar um espaço que a cidade usa é ser percebida como parceira do bairro, não como anunciante dele. É o tipo de associação que mídia avulsa não compra, em um mercado onde quase toda marca fala de propósito e quase nenhuma tem onde apontar.',
      ],
    },
