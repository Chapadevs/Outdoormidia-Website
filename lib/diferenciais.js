...
export const TODOS_DIFERENCIAIS = [
  ...
  },
  {
    ...
    monitoramento: {
      ...
      // TODO(cliente): vídeo de monitoramento das câmeras. Bloqueia a seção.
      video: null,
      paragrafos: [
    ...
    leitura: {
      ...
      dados: [
        { n: '85,5%', label: 'do público entre 18 e 60 anos' },
        { n: '55,6%', label: 'masculino' },
        { n: '44,4%', label: 'feminino' },
        { n: '35,5%', label: 'classe C+' },
        { n: '29,9%', label: 'classes A/B' },
      ],
    },
    privacidade: {
  ...
  },
  {
    ...
    //
    // É teaser, não seção: a Gestão 360 OM já tem seção inteira na home, com os
    // três passos, e o `href` entrega o leitor lá embaixo. Não crescer este
    // card. Se ele ganhar os três passos ou virar bloco grande, a seção da home
    // perde a razão de existir. Três linhas e a âncora.
    slug: 'gestao-360-om',
    publicado: true,
    title: 'Gestão 360 OM',
