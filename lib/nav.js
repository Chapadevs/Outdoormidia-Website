...
// /area-do-anunciante, o diagnóstico passou para dentro dela e os dois itens
// renomeados (Guia do Anunciante, Sua marca no OOH) trocaram de rota junto. As
// URLs antigas seguem vivas como redirect permanente em next.config.mjs.
export const NAV = [
  {
    label: 'Sobre nós',
    href: '/sobre',
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Guia do Anunciante', href: '/area-do-anunciante/guia-do-anunciante' },
