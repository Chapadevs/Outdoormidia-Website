export const TAG_SCOPES = [
  {
    id: 'blog',
    label: 'Blog',
    desc: 'Classificam os posts e suas imagens. Aparecem nos cards do blog e na página de cada artigo. Plataforma, Cobertura e Indústrias são grupos fixos: nenhum post é publicado sem ao menos uma tag de cada um.',
  },
  {
    id: 'cases',
    label: 'Cases',
