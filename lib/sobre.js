...
//
// TODO(Imagine): falta uma imagem por marco (`image`, 16/9, ≥1600px, com
// `imageAlt` descrevendo a cena). Sem ela o card fica só com ano, título e
// texto, como está hoje.
export const MARCOS = [
  {
    ano: '1959',
  ...
  },
  {
    ...
    text: 'As rodovias de PR e SC e as praças catarinenses entram no roteiro. O portfólio se expande até formar as nove plataformas integradas de OOH: a única operação do Paraná com esse alcance.',
    image: null,
    imageAlt: null,
  },
  {
