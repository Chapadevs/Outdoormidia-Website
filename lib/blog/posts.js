...
// cache() memoiza por request: generateMetadata e a própria página pedem o
// mesmo post — sem isso, a mesma query roda duas vezes por render.
...
function toDoc({ title, slug, excerpt, content, coverImage, coverAlt, status, author, tags }) {
  return {
    title,
    slug,
    excerpt,
...
export async function updatePost(id, body) {
  ...
  // o slug antigo é o que a rota usa para invalidar a URL anterior do post
