...
import { NUMEROS_MARCA as en } from '@/lib/i18n/content/numeros.en'
import { NUMEROS_MARCA as es } from '@/lib/i18n/content/numeros.es'
import { NUMEROS_MARCA as zh } from '@/lib/i18n/content/numeros.zh'

const conteudo = porLocale(NUMEROS_MARCA, { en, es, zh })

export function getNumerosMarca(locale) {
