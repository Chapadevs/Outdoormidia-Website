...
export const PLATFORMS = [
  ...
  },
  {
    ...
    formats: [
      ...
      // Enquanto isso, quem ilustra o card é a peça recortada (`image`), no
      // lugar do diagrama; os PNG originais ficam em
      ...
      },
      {
        ...
        image: '/media/digital-signage/posto-de-combustivel.webp',
        imageAlt: 'Painel de LED vertical da Outdoormídia na fachada de um prédio comercial',
      },
      {
        aspect: '3/1',
        dims: 'Passagem',
        ...
        image: '/media/digital-signage/passagem-digital.webp',
        imageAlt: 'Painel de LED vertical da Outdoormídia instalado junto à entrada de um edifício',
      },
    ],
