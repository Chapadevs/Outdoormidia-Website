...
export const PLATFORMS = [
  {
    ...
    num: '01',
    name: 'Outdoors Digitais',
    desc: 'LED · Dinâmico',
    short: '82 equipamentos e 138 telas de LED, com troca de criativo na hora e sem produção de lona.',
    eyebrow: 'Plataforma · Digital',
    heading: 'Outdoors Digitais.',
    intro:
      '82 equipamentos e 138 telas de LED de alta definição, com troca dinâmica de criativos e câmeras ao vivo 24×7 em todos os pontos. Ideal para campanhas que precisam de flexibilidade, mensuração e agilidade de veiculação.',
    formats: [
      {
        aspect: '16/9',
        top: 'LED',
  ...
  },
  {
    ...
    name: 'Front Lights',
    desc: '18 m² · Iluminado',
    short: 'Outdoor iluminado de 18 m² nos corredores de maior fluxo — o maior volume de ativos da casa.',
    eyebrow: 'Plataforma · Grande formato',
    heading: 'Front Lights.',
    intro:
    ...
    faqs: [
      {
        ...
        a: 'Os dois têm 18 m², mudando apenas a orientação — a escolha depende do ponto disponível e da leitura desejada na via.',
      },
      {
  ...
  },
  {
    ...
    num: '03',
    name: 'Mídia Indoor',
    desc: 'Ponto de compra',
    short: 'Totens e painéis 100% digitais dentro dos shoppings, a poucos passos da decisão de compra.',
  ...
  },
  {
    ...
    num: '04',
    name: 'Aeroporto',
    desc: 'Público premium',
    short: 'Operação privada no Afonso Pena, com a maior empena digital do Sul do Brasil.',
  ...
  },
  {
    ...
    name: 'Mídia Móvel',
    desc: 'Em movimento',
    short: 'Ativações em praias, parques e calçadões — onde o OOH fixo não chega.',
  ...
  },
  {
    ...
    num: '06',
    name: 'MUB',
    desc: 'Mobiliário urbano',
    short: '77 locais em 6 circuitos segmentados, somando 13 milhões de impactos por mês.',
    eyebrow: 'Plataforma · Circuitos segmentados',
    heading: 'MUB.',
    intro:
      '77 locais em 6 circuitos segmentados — Full, Saúde, Educação, Shoppings, Alto Padrão e Super & Hiper — somando 13 milhões de impactos por mês. O maior roteiro de MUB digitalizado em uma única cidade no Brasil.',
    formats: [
      {
        aspect: '10/3',
        top: '10 m',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: '77 locais, somando 13 milhões de impactos por mês — o maior roteiro de MUB digitalizado em uma única cidade no Brasil.',
      },
      {
        q: 'Posso escolher só um circuito específico?',
        a: 'Sim, é possível contratar o circuito mais alinhado ao seu público-alvo, sem precisar veicular na malha completa.',
      },
    ],
  },
  // TODO(cliente): descritivo oficial, praças por trecho e os números de fluxo
  // das rodovias. O que está aqui veio do inventário interno (100 ativos,
  // 12×4 m e passarelas 10×3 m) e basta para o card e a página existirem.
  {
    slug: 'rodovias',
    num: '07',
    name: 'Rodovias',
    desc: 'Alto fluxo · Estrada',
    short: '100 ativos nas rodovias do PR e de SC, dimensionados para leitura em velocidade.',
    eyebrow: 'Plataforma · Rodovias',
    heading: 'Rodovias.',
    intro:
      '100 ativos nas principais rodovias do Paraná e de Santa Catarina, incluindo painéis de 12×4 m e passarelas de 10×3 m. Alcance de quem viaja a trabalho ou a lazer, em trechos de fluxo constante e leitura a distância.',
    formats: [
      {
        aspect: '3/1',
        top: '12 m',
    ...
    faqs: [
      {
        ...
        a: 'A malha cobre as principais vias do Paraná e de Santa Catarina, somando 100 ativos. O trecho exato é definido conforme a praça e o público que você quer alcançar — traga a região no briefing.',
      },
      {
      ...
      },
      {
        ...
        a: 'A malha rodoviária é majoritariamente impressa. Se a campanha precisa de troca dinâmica de criativo, o caminho são os Outdoors Digitais — ou uma combinação das duas plataformas.',
      },
    ],
  },
]
...
const ICONICOS_NA_LISTAGEM = {
  ...
  name: 'Icônicos',
  desc: 'Projetos de assinatura',
  short: 'Estruturas sob medida, desenhadas ponto a ponto, com fluxo comercial próprio.',
  intro: `Estruturas sob medida, desenhadas ponto a ponto: ${ICONICOS.map((i) => i.name).join(', ')}. Fluxo comercial próprio, que começa no briefing e não na tabela.`,
  href: '/plataformas/projetos-iconicos',
  cta: 'Ver os projetos',
  marcador: 'Fora do catálogo',
}

const POSICAO_ICONICOS = 2
