...
// Versao de cada idioma. So o nome do corredor: o resto e geometria e nome
// proprio.
import { porLocale } from '@/lib/i18n/overlay'
import { CORREDORES as corredoresEn } from '@/lib/i18n/content/mapaRodovias.en'
import { CORREDORES as corredoresEs } from '@/lib/i18n/content/mapaRodovias.es'
import { CORREDORES as corredoresZh } from '@/lib/i18n/content/mapaRodovias.zh'

const conteudoCorredores = porLocale(CORREDORES, {
  en: corredoresEn,
  es: corredoresEs,
  zh: corredoresZh,
})

export function getCorredores(locale) {
  return conteudoCorredores(locale)
}
