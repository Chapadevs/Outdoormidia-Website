...
export const PAGINAS = [
  ...
  },
  {
    ...
    resumo:
      'Diagnóstico de presença, Guia do Anunciante para download, Sua marca no OOH e FAQ: as ferramentas para resolver sozinho antes de falar com o comercial.',
    priority: 0.8,
    changeFrequency: 'monthly',
    destaque: true,
  },
  ...
  {
    path: '/area-do-anunciante/guia-do-anunciante',
    titulo: 'Guia do Anunciante',
    resumo:
