...
// Ponte para as plataformas de menor impacto que já existem no site.
// TODO: incluir Regenerativo quando a retaxonomia criar o slug em lib/platforms.js.
export const AMBIENTAL_PRODUTOS = [
  {
    href: '/plataformas/green',
    eyebrow: 'Plataforma · Sustentabilidade',
    title: 'Green',
    text: 'Estruturas pensadas com materiais e processos de menor impacto, incluindo jardins verticais e iluminação eficiente.',
    cta: 'Ver a plataforma Green',
  },
  {
    href: '/plataformas/gentileza-urbana',
    eyebrow: 'Plataforma · Cidade',
    title: 'Gentileza Urbana',
    text: 'Mídia que devolve algo à rua: mobiliário e intervenções que a cidade usa todo dia, com a marca junto.',
    cta: 'Ver Gentileza Urbana',
  },
  {
    href: '/plataformas/projetos-iconicos',
    eyebrow: 'Plataforma · Icônicos',
    title: 'Jardins verticais',
    text: 'Estrutura vegetada em ponto monumental — apelo visual e cobertura verde na mesma face.',
    cta: 'Ver Projetos Icônicos',
  },
]
