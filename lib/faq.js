// Perguntas frequentes — usadas na seção da home e na página /anunciante/faq.
// A ordem é a da home; a página agrupa por `categoria`.
...
export const FAQS = [
  ...
  },
  {
    ...
    a: 'São 7 plataformas de catálogo: Outdoors Digitais, Front Lights, Mídia Indoor, Aeroporto, Mídia Móvel, MUB (mídia urbana em ônibus) e Rodovias. Além delas, há os Icônicos: 3 projetos sob medida — Elegancy, Green e Regenerativo. Cada opção cobre um objetivo e um perfil de público diferente.',
  },
  {
